...
function createCrystalColorPicker() {
    ...
    picker.innerHTML = `
        <div style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background: rgba(0,0,0,0.9); padding: 20px; border-radius: 10px; z-index: 10002; border: 2px solid #444; font-family: Arial; color: white; min-width: 280px; backdrop-filter: blur(5px); box-shadow: 0 0 30px rgba(0,0,0,0.8);">
            <div style="font-weight: bold; margin-bottom: 15px; font-size: 16px; text-align: center; color: #4fc3f7;">Crystal Colors</div>
            
            <div style="margin-bottom: 15px; display: flex; align-items: center; justify-content: space-between;">
                <span style="font-size: 14px; color: #ccc;">Main Color:</span>
            ...
            <div style="margin-bottom: 15px; display: flex; align-items: center; justify-content: space-between;">
                <span style="font-size: 14px; color: #ccc;">Glow Color:</span>
                <div style="display: flex; align-items: center;">
            ...
            <div style="display: flex; gap: 10px; margin-top: 15px;">
                <button id="crystal-color-reset" style="flex: 1; background: #e74c3c; color: white; border: none; padding: 8px; border-radius: 5px; cursor: pointer; font-size: 12px;">Reset</button>
                <button id="crystal-color-close" style="flex: 1; background: #34495e; color: white; border: none; padding: 8px; border-radius: 5px; cursor: pointer; font-size: 12px;">Close</button>
            </div>
        </div>
        ...
        <div style="margin-bottom: 20px;">
            ...
            <div style="background: rgba(255,152,0,0.1); padding: 15px; border-radius: 8px; border-left: 4px solid #ff9800;">
                <ul style="margin: 0; padding-left: 20px; font-size: 14px;">
                    <li>Добавлена система кастомных цветов кристаллов</li>
                    <li>Новая функция Crystal Colors с выбором основного цвета и цвета бликов</li>
                    <li>Кнопка "Crystal Colors" в настройках</li>
                    <li>Обновлен интерфейс выбора цветов</li>
                </ul>
            </div>
        </div>
...
function createCrystalColorsMenu(menu) {
    ...
    if (crystalColorsEnabled) {
        const colorPickerButton = createMenuButton('🎨 Choose Colors', (event) => {
            event.stopPropagation();

                ...
                if (blankIndex !== -1) {
                    ...
                    badgeEntries.forEach(([key, value], index) => {
                        ...
                        if (index === blankIndex) {
                            ...
                            newBadges.shipdesigner = "Ship Designer";
                            newBadges.x27 = "X-27";
                            newBadges.loveship = "Loveship";
                            newBadges.paralx = "Paralx";
                            newBadges.iridiumore = "Iridium Ore";
                            newBadges.carme = "Carme";
                            newBadges.pudding = "Pudding";
                            newBadges.acarii = "Acarii";
                            newBadges.scarn = "Scarn";
                            newBadges.tournebulle = "Tournebulle";
                            newBadges.pleshkov = "DankDmitron";
                            newBadges.oh = "Oh_";
                            newBadges.ancientsky = "Ancient Sky";
                            newBadges.kleinem = "Kleinem";
                            newBadges.2k = "Double K";
                            newBadges.xcommander = "X-Commander";
                            newBadges.fady = "Fady";
                            newBadges.andromeda = "Andromeda";
                            newBadges.mortyrules = "Morty Rules";
                            newBadges.pell = "Pell";
                            newBadges.dimed = "Dimed";
                            newBadges.finalizer = "Finalizer";
                            newBadges.mikr = "5470p3_";
                            newBadges.goldman = "Goldman";
                            newBadges.uranus = "Uranus";
                            newBadges.nova = "Nova";
                            newBadges.45rfew = "45rfew";
                            newBadges.bhpsngum = "Bhpsngum";
                            newBadges.valiant = "Valiant";
                            newBadges.notus = "123 Notus";
                            newBadges.destroy = "Destroy";
                            newBadges.schickenman = "SChickenMan";
                        }
                    });
    ...
    (function() {
        ...
        if (prototypeWithDrawIcon && prototypeWithDrawIcon.drawIcon) {
            ...
            prototypeWithDrawIcon.drawIcon = function(t, e, i) {
                ...
                } else if (this.icon === "shipdesigner") {
                    this.icon = "https://starblast.io/ecp/shipdesigner.jpg";
                ...
                } else if (this.icon === "paralx") {
                    this.icon = "https://starblast.io/ecp/paralx.jpg";
                } else if (this.icon === "iridiumore") {
                    this.icon = "https://starblast.io/ecp/iridium_ore.jpg";
                } else if (this.icon === "carme") {
                    this.icon = "https://starblast.io/ecp/carme.jpg";
                } else if (this.icon === "pudding") {
                    this.icon = "https://starblast.io/ecp/pudding.jpg";
                } else if (this.icon === "acarii") {
                    this.icon = "https://starblast.io/ecp/acarii.jpg";
                } else if (this.icon === "scarn") {
                    this.icon = "https://starblast.io/ecp/scarn.jpg";
                } else if (this.icon === "tournebulle") {
                    this.icon = "https://starblast.io/ecp/tournebulle.png";
                } else if (this.icon === "pleshkov") {
                    this.icon = "https://starblast.io/ecp/blackstar.jpg";
                } else if (this.icon === "oh") {
                    this.icon = "https://starblast.io/ecp/oh.jpg";
                } else if (this.icon === "ancientsky") {
                    this.icon = "https://starblast.io/ecp/ancientsky.jpg";
                } else if (this.icon === "kleinem") {
                    this.icon = "https://starblast.io/ecp/keinem.jpg";
                } else if (this.icon === "2k") {
                    this.icon = "https://starblast.io/ecp/2k.jpg";
                } else if (this.icon === "xcommander") {
                    this.icon = "https://starblast.io/ecp/xcommander.jpg";
                } else if (this.icon === "fady") {
                    this.icon = "https://starblast.io/ecp/fady.jpg";
                } else if (this.icon === "andromeda") {
                    this.icon = "https://starblast.io/ecp/andromeda.jpg";
                } else if (this.icon === "mortyrules") {
                    this.icon = "https://starblast.io/ecp/mortyrules.jpg";
                } else if (this.icon === "pell") {
                    this.icon = "https://starblast.io/ecp/pell.jpg";
                } else if (this.icon === "dimed") {
                    this.icon = "https://starblast.io/ecp/dimed.jpg";
                } else if (this.icon === "finalizer") {
                    this.icon = "https://starblast.io/ecp/finalizer.jpg";
                } else if (this.icon === "mikr") {
                    this.icon = "https://starblast.io/ecp/mikr.jpg";
                } else if (this.icon === "goldman") {
                    this.icon = "https://starblast.io/ecp/goldman.jpg";
                } else if (this.icon === "uranus") {
                    this.icon = "https://starblast.io/ecp/uranus.jpg";
                } else if (this.icon === "nova") {
                    this.icon = "https://starblast.io/ecp/nova.jpg";
                } else if (this.icon === "45rfew") {
                    this.icon = "https://starblast.io/ecp/45rfew.jpg";
                } else if (this.icon === "bhpsngum") {
                    this.icon = "https://starblast.io/ecp/bhpsngum.png";
                } else if (this.icon === "valiant") {
                    this.icon = "https://starblast.io/ecp/valiant.jpg";
                } else if (this.icon === "notus") {
                    this.icon = "https://starblast.io/ecp/notus.png";
                } else if (this.icon === "destroy") {
                    this.icon = "https://starblast.io/ecp/destroy.png";
                } else if (this.icon === "schickenman") {
...
const languages = {
    ru: {
        ...
        changelog: {
            ...
            content: `
                <div style="text-align: center; margin-bottom: 20px; padding: 15px; background: rgba(255,255,255,0.1); border-radius: 10px;">
                    ...
                    <p style="margin: 0; font-size: 14px; opacity: 0.8;">Версия 1.0.1</p>
                </div>
        ...
        badgesInfoEnabled: 'Значки доступны',
    ...
    en: {
        ...
        changelog: {
            ...
            content: `
                <div style="text-align: center; margin-bottom: 20px; padding: 15px; background: rgba(255,255,255,0.1); border-radius: 10px;">
                    <h3 style="margin: 0 0 10px 0; color: #4CAF50;">🚀 Starblast Function Customizer</h3>
                    <p style="margin: 0; font-size: 14px; opacity: 0.8;">Version 1.0.1</p>
                </div>
        ...
        badgesInfoEnabled: 'Badges available',
    ...
    tr: {
        ...
        changelog: {
            ...
            content: `
                <div style="text-align: center; margin-bottom: 20px; padding: 15px; background: rgba(255,255,255,0.1); border-radius: 10px;">
                    <h3 style="margin: 0 0 10px 0; color: #4CAF50;">🚀 Starblast Function Customizer</h3>
                    <p style="margin: 0; font-size: 14px; opacity: 0.8;">Sürüm 1.0.1</p>
                </div>
        ...
        badgesInfoEnabled: 'Rozetleri mevcut',
